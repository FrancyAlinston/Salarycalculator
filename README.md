...
- **Visual Shift Heatmap Color Legend (`ShiftCalendarDialog.kt`):** Prominent color legend bar defining 🟢 Standard 8h Shift (`Emerald60`), 🟠 Overtime 10h Shift (`Amber60`), 🔴 Long/Night 12h Duty (`Rose60`), 🔵 Part-Time <8h Shift (`Teal60`), and ⚪ Day Off.
